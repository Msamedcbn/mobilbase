...
type Role = "ADMIN" | "CASHIER" | "TECHNICIAN";
...
export default function BuybackBackofficePage() {
  ...
  if (adminOnly && me.role !== "ADMIN") return <section className="panel" style={{ padding: "1rem" }}>Bu alan pilotta sadece ADMIN rolune acik.</section>;

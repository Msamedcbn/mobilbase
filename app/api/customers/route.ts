      ...
      const mockTenants = [
        {
          id: "mock-tenant-1",
          nationalId: null,
          fullName: "TeknoMarket Zinciri A.Ş.",
          phone: "08502220185",
          ...
          notes: JSON.stringify({
            ...
            billingLedger: [
              { id: "b1", type: "CHARGE", category: "LICENSE", amount: 42000, description: "Enterprise Yıllık Paket Ücreti (250 Şube Lisansı)", date: "2026-01-01" },
        ...
        },
        {
          ...
          notes: JSON.stringify({
            ...
            billingLedger: [
              { id: "b8", type: "CHARGE", category: "LICENSE", amount: 28000, description: "Enterprise Yıllık Paket Ücreti (150 Şube Lisansı)", date: "2026-02-01" },
        ...
        },
        {
          ...
          notes: JSON.stringify({
            ...
            billingLedger: [
              { id: "b10", type: "CHARGE", category: "LICENSE", amount: 18000, description: "Enterprise Yıllık Paket Ücreti (100 Şube Lisansı)", date: "2026-03-01" },
        ...
        },
        {
          ...
          notes: JSON.stringify({
            ...
            tickets: [],
            billingLedger: [
              { id: "b12", type: "CHARGE", category: "LICENSE", amount: 12000, description: "Pro Yıllık Paket Ücreti (54 Şube Lisansı)", date: "2026-04-01" },
  ...
  try {
    ...
    if (isDbDisabledMode()) {
      ...
      if (existing) {
        ...
        await writeLocalStore(store);
        return ok(existing, 201, "Musteri kaydi basarili");
      }
      const created = {
        id: localId("cust"),
      ...
      await writeLocalStore(store);
      return ok(created, 201, "Musteri kaydi basarili");
    }
    ...
    return ok(item, 201, "Musteri kaydi basarili");
  } catch (error) {
    return fail(getErrorMessage(error), getErrorCode(error), getErrorStatus(error));
  }
}

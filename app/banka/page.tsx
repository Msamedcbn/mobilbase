  ...
  return (
    <section className="space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
        <div className="glass-card p-6 rounded-2xl bg-gradient-to-r from-teal-900 to-slate-900 border border-teal-500/20 shadow-md relative overflow-hidden w-full md:w-96">
          ...
          <p className="text-xs font-semibold text-teal-400 uppercase tracking-wider">Toplam Kasa / Banka Varlığı</p>
        ...
        <button
          ...
          className="px-6 py-3 bg-teal-600 hover:bg-teal-500 text-white font-medium rounded-xl transition-all shadow-lg hover:shadow-teal-500/20 active:scale-95 flex items-center gap-2"
        >
          ...
          return (
            ...
            >
              ...
              <div className="mt-6 flex justify-between items-baseline">
                ...
                <span className={`text-2xl font-black font-mono ${isSelected ? "text-teal-400" : "text-teal-600"}`}>
          ...
          <div className="w-full max-w-md bg-white border border-slate-200 rounded-2xl p-6 shadow-md space-y-6">
            ...
            <form onSubmit={handleAdd} className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent font-mono"
                  placeholder="TR00..."
                  value={iban}
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-teal-600 hover:bg-teal-500 text-white text-sm font-medium rounded-xl transition-all"
                >
                  Hesap Oluştur
                </button>
              </div>

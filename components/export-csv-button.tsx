...
// For server components: accessor functions in CsvColumn can't cross the
// server/client boundary as props, so build the CSV string server-side with
// rowsToCsv() and pass the plain string here instead.
export function DownloadCsvButton({
  ...
  return (
    <button
      ...
      title={rowCount === 0 ? "Aktarılacak veri yok" : `${rowCount} satır CSV olarak indirilecek`}
    >

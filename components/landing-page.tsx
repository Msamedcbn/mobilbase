          ...
          <div className="rounded-[2.5rem] border border-white/[0.08] bg-gradient-to-br from-blue-500/[0.06] via-white/[0.02] to-transparent p-1.5">
            <div className="rounded-[2.125rem] px-6 py-16 text-center md:px-16 md:py-20">
              ...
              <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
                ...
                <a href="tel:+905454403452" className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-8 py-3.5 text-sm font-bold text-white transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-white/10 hover:border-white/30 active:scale-[0.98]">
